        ...
        function horizontalWidth() {
            ...
            for (var i = 0; i < columnModel.count; i++) {
                if (columnModel.get(i).visible) {
                    total += columnModel.get(i).width
                }
            }
            return Math.max(tableBody.width, total)
        }
                            ...
                            Repeater {
                                ...
                                delegate: Rectangle {
                                    ...
                                    MouseArea {
                                        id: titleDragArea
                                        anchors.fill: parent
                                        anchors.rightMargin: model.resizable ? root.tableResizeHandleWidthPx : 0
                                        hoverEnabled: true
                                        ...
                                        onReleased: function(mouse) {
                                            if (headerCell.manualDragging) {
                                                ...
                                                if (targetKey && targetKey !== headerCell.columnKey) {
                                                    ...
                                                    if (toIdx >= 0) {
                                                        columnModel.move(index, toIdx, 1)
                                                    }
                                    ...
                                    Text {
                                        ...
                                        anchors.rightMargin: model.resizable ? root.tableResizeHandleWidthPx : 8
                                        ...
                                        font.bold: true
                                        verticalAlignment: Text.AlignVCenter
                                        horizontalAlignment: model.align === "right" ? Text.AlignRight : Text.AlignLeft
                                        elide: Text.ElideRight
                                    }
                                    ...
                                    MouseArea {
                                        ...
                                        onPositionChanged: function(mouse) {
                                            var mapped = resizeHandle.mapToItem(root, mouse.x, mouse.y)
                                            var newWidth = Math.max(model.minWidth, startWidth + (mapped.x - startRootX))
                                            columnModel.setProperty(index, "width", newWidth)
                                ...
                                Repeater {
                                    ...
                                    delegate: Rectangle {
                                        ...
                                        Text {
                                            ...
                                            anchors.rightMargin: model.resizable ? root.tableResizeHandleWidthPx : 8
                                            text: table.cellText(rowDelegate.rowData, model)
                                            color: root.inkColor
                                            opacity: 0.92
                                            font.family: visualRules.textFontFamily
                                            font.pixelSize: 12
