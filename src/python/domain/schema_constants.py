...
TABLE_COLUMNS: Dict[str, List[str]] = {
    ...
    TBL_TIME: [
        ...
        COL_TIME_INVOICE_DATE, COL_TIME_LOCK_AUDIT, COL_TIME_CREATED
    ],
    TBL_TRADEMARKS: [
        COL_TM_ID,
        COL_TM_JURISDICTION,
    ...
    TBL_DRAFT_INVOICES: [
        ...
        COL_DRAFT_CLIENT_NAME, COL_DRAFT_DATE, COL_DRAFT_DISCOUNT_TYPE, COL_DRAFT_DISCOUNT_VALUE, COL_DRAFT_TOTAL_FEES, COL_DRAFT_TOTAL_DISB, COL_DRAFT_TOTAL_TAX, COL_DRAFT_TOTAL_DUE,
        COL_DRAFT_GROUPING_PREF, COL_DRAFT_CREATED_AT, COL_DRAFT_UPDATED_AT
    ],
    TBL_CORP_ENTITIES: [
