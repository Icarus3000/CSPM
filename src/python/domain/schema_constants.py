...
TABLE_ALIASES: Dict[str, Dict[str, List[str]]] = {
    ...
    TBL_DISBURSEMENTS: {
        COL_DISB_DATE: ["DisbursementDate", "ExpenseDate"],
        COL_DISB_CLIENT_NAME: ["Client", "BillingClient", "ParentName"],
        COL_DISB_SUB_CLIENT: ["Sub-Client", "WorkClient", "ServiceClient"],
        COL_DISB_CLIENT_ID: ["Client Id", "Client_ID"],
        COL_DISB_PARENT_ID: ["Parent Id", "Parent_ID"],
        COL_DISB_MATTER_ID: ["Matter", "Matter_ID", "MatterNumber", "MatterNo"],
        COL_DISB_DESCRIPTION: ["Details", "Memo", "Narrative", "DisbursementDescription"],
        COL_DISB_AMOUNT: ["ExpenseAmount", "DisbursementAmount", "Total"],
        COL_DISB_TAX_EXEMPT: ["Tax Exempt? (Y/N)", "TaxExemptFlag"],
        COL_DISB_BILL_PCT: ["Bill %", "RecoveryPercent", "ClientRecoveryPercent"],
        COL_DISB_INVOICE_REF: ["Invoice", "Invoice #", "InvoiceNum", "InvoiceNumber"],
        COL_DISB_CREATED_AT: ["Created", "CreatedDate"],
        COL_DISB_SUPPLIER_INVOICE_REF: ["SupplierInvoice", "Supplier Invoice"],
    },
    TBL_TRADEMARKS: {
