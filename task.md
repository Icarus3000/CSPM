...
- [x] Scope guard: conflict checking remains inactive; the seven unrelated workbook warnings were not addressed; no EXE build, commit, push, or workbook mutation was performed.
