...
- [ ] Next separate high-priority issue: make the Custom Fee workflow idempotent and prevent future orphan creation. Do not combine that production-behavior change with this completed historical repair.
