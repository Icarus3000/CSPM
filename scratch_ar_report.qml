...
Item {
    ...
    function _aggregateRows() {
        return [
            { "metric": "Open A/R", "value": money(root.summaryValue("totalAr")) },
    ...
    Rectangle {
        ...
        ScrollView {
            ...
            ColumnLayout {
                ...
                GridLayout {
                    Layout.fillWidth: true
                    columns: Math.max(1, Math.min(5, Math.floor(width / 210)))
                    columnSpacing: 8
                    rowSpacing: 8
